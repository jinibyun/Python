...
class Eagle(Bird):
    def fly(self): # there is no "override" keyword. But it is now overriding.
        print("very fast") # method overriding

class FalseEagle(Bird):
    pass
...
falseEagle = FalseEagle()
falseEagle.fly()


# create exception: inherit exception class (Python built-in class)
